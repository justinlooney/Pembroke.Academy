...
| | `check-conversation-facing.mjs` | all 14 models keep their torso and head toward the conversation camera throughout talking loops, keep animating, and return to their campus transforms on Leave |
